...
function EventoCadastro(props) {
  ...
  // storage armazena os recursos do storage
  const storage = firebase.storage();
  // db armazena os recursos do firestore
  ...
  function cadastrar() {
    ...
    // passando como referência o local que vai armazenar a imagem
    // put faz upload da imagem
    storage
      ...
      .then(() => {
        db.collection("eventos")
          .add({
            ...
            vizualizacoes: 0,
            foto: fotoNova.name, //recuperar o lugar que ele tá salva
            publico: 1,
            criacao: new Date(),
          })
          .then(() => {
      ...
      <div className="col-12 mt-5">
        ...
        <form>
          ...
          <div className="form-group">
            ...
            <input
              onChange={(e) => setFotoNova(e.target.files[0])} //permite uma única foto
              type="file"
              className="form-control"
            />
          </div>
