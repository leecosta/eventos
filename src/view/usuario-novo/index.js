...
function NovoUsuario() {
  ...
  function cadastrar() {
    ...
    // Se o email ou senha estiverem vazios
    if (!email || !senha) {
      setMsgTipo("erro");
  ...
  return (
    // return só retorna um elemento, como estou importando o Navbar e a div então colocamos esse símbolo para ele entender apenas como um
    <>
      <Navbar />
